...
public class AuthRestAPIs {
	...
	public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginForm loginRequest) {
		...
		System.out.println("Controller authenticateUser 1 - 5 name " + loginRequest.getUsername() + " password = "+loginRequest.getPassword());
...
//				new UsernamePasswordAuthenticationToken(loginRequest.getUsername(), loginRequest.getPassword()));
    	...
    	System.out.println("2 Controller authenticateUser 1 - 5 - 0");
    	
		
    	// # First approach
		UserPrinciple userPrinciple = (UserPrinciple) userAuthService.loadUserByUsername(loginRequest.getUsername());		
		System.out.println("2 Controller authenticateUser 1 - 5 - 1 name = = " + userPrinciple.getUsername() + " email = "+userPrinciple.getEmail()  + " getPassword = " +userPrinciple.getPassword());
		
		// # Second approach 
		System.out.println("2 Controller authenticateUser 1 - 5 - 2 name = = " + userPrinciple.getUserDo().getUsername() + " email = "+userPrinciple.getUserDo().getEmail()  + " getPassword = " +userPrinciple.getPassword());
...
//	@GetMapping("/api/test/members")
	...
	public List<Member> getMembers() {
		System.out.println("AuthRestAPIs getMembers() ##############");
		return membersList;
	}
	...
	private static List<Member> createMemberList() {
		...
		Member emp1 = new Member();
		emp1.setId(41);
		emp1.setFirst_name("Joan");
		emp1.setLast_name("Brown");
		emp1.setUser_name("jbrown");
		emp1.setCountry("Canada");

		Member emp2 = new Member();
		emp1.setId(40);
		emp1.setFirst_name("Mort");
		emp1.setLast_name("Johnston");
		emp1.setUser_name("morty");
		emp1.setCountry("Canada");
		
		tempMembers.add(emp1);
		tempMembers.add(emp2);
		return tempMembers;
	}
	*/
