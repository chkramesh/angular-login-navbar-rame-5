...
//			}
		...
		// Then call application roles database call
		 ...
		 if(username.equalsIgnoreCase("venkat") || username.equalsIgnoreCase("venkat@test.com")) {
			 System.out.println("UserDetailsServiceImpl 1 - 1 login() username ============= " +username + " password = "+ password);
		//if (StringUtils.eequalsIgnoreCase(username, "venkat")) {
			...
			// return userRole;			 
			 return appUserDo;
			  ...
			  System.out.println("UserDetailsServiceImpl 1 - 2 login() username ============= " +username + " password = "+ password);
				 long longValue = 1;
...
//				 roles.add("ADMIN");			 
			  ...
			  System.out.println("UserDetailsServiceImpl 1 - 3 login() username ============= " +username + " password = "+ password);
				 long longValue = 1;
//				 appUserDo = new UserDO(longValue , "adamadam", "venkat","adamadam@testmail.com","adamadam");
//				 appUserDo = new UserDO(longValue, "User First", "User Last", "NY", "user","user@testmail.com", password);
			  ...
			  System.out.println("UserDetailsServiceImpl 1 - 4 login() username ============= " +username + " password = "+ password);
				 long longValue = 1;
//				 appUserDo = new UserDO(longValue , "adamadam", "venkat","adamadam@testmail.com","adamadam");
...
//				 appUserDo = new UserDO(longValue, "Cashier First", "Cashier Last", "PA", "cashier","cashier@testmail.com", password);
			  ...
			  System.out.println("UserDetailsServiceImpl ELSE 1 - 7 login() username ============= " +username + " password = "+ password);
		  }
		 
		 System.out.println("UserDetailsServiceImpl ELSE 1 - 7 login() appUserDo ============= " +appUserDo);
